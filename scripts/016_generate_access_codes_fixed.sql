...
-- FIXED: Using correct column name 'codigo' instead of 'code'
...
BEGIN
  WHILE inserted_count < 2000 AND attempt_count < max_attempts LOOP
    ...
    BEGIN
      -- Fixed column names: 'codigo' instead of 'code', 'utilizada' instead of 'used'
...
-- Show statistics
-- Fixed column name: 'utilizada' instead of 'used'
SELECT 
